...
try:
    ...
    with tab1:
        ...
        # --- ROW 1: CHARTS ---
        r1_chart1, r1_chart2 = st.columns(2)
        with r1_chart1:
        ...
        # --- ROW 2: CHARTS ---
        r2_chart1, r2_chart2 = st.columns(2)
        with r2_chart1:
    ...
    with tab2:
        ...
        # --- ROW 3: CHARTS ---
        r3_chart1, r3_chart2 = st.columns(2)
        with r3_chart1:
        ...
        # --- ROW 4: CHARTS ---
        r4_chart1, r4_chart2 = st.columns(2)
        with r4_chart1:
    ...
    with tab3:
        ...
        # --- ROW 5: CHARTS ---
        r5_chart1, r5_chart2 = st.columns(2)
        with r5_chart1:
        ...
        # --- ROW 5: EXPANDERS ---
        r5_exp1, r5_exp2 = st.columns(2)
        with r5_exp1:
            with st.expander("Explanation"):
                st.markdown("""
                - **What it represents:** Correlation between IMDb and TMDB scores, sized by total votes and colored by type.
        ...
        # --- ROW 6: CHARTS ---
        r6_chart1, r6_chart2 = st.columns(2)
        with r6_chart1:
    ...
    st.error("⚠️ Dataset file not found! Please ensure 'titles.csv' and 'credits.csv' are in the same folder as this script.")
